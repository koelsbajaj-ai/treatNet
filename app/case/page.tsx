...
function CaseContent() {
  ...
  // The left rail (in AppShell, shared across routes) and the landing
  // page's case entry points both link to "/case?demo=<id>" rather than
  // calling handleLoadDemo directly — this is what makes clicking a demo
  // case from the landing page or the landscape page correctly land back
  // here with that case loaded.
  useEffect(() => {
